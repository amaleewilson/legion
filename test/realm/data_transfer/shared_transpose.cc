...
#define PTX_FILE "shared_transpose_gpu64.ptx"
#define CUBIN_FILE "shared_transpose_gpu64.cubin"
#else
#define PTX_FILE "shared_transpose_gpu32.ptx"
#define CUBIN_FILE "shared_transpose_gpu32.cubin"
#endif
...
////// kernel timing
  ...
  std::cout << "shared_transpose," << kernel_time  << ",2," << num_elems << "," << mem_size_A << "," << mem_size_A/kernel_time/1000000 << std::endl;
}
