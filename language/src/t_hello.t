...
terra terra_hello(N : double) : double
  C.printf("hello from terra function\n")
  return N * 3.14
end
...
local name = ffi.os == "Windows" and ".\\cuda_hello.dll" or "./cuda_hello.so"
terralib.saveobj("cuda_hello.so",{ main = main, terra_hello = terra_hello },args)
